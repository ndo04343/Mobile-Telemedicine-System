...
public class DoctorDiagnosisActivity extends Activity {
    private static final String TAG = "DoctorDiagnosisActivity";
    ...
    private void connectToRoom(String roomId, boolean commandLineRun, boolean loopback,
        ...
        DoctorDiagnosisActivity.commandLineRun = commandLineRun;
