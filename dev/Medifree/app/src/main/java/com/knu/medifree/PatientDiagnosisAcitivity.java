...
public class PatientDiagnosisAcitivity extends Activity {
    private static final String TAG = "PatientDiagnosisAcitivity";
    ...
    private void connectToRoom(String roomId, boolean commandLineRun, boolean loopback,
        ...
        PatientDiagnosisAcitivity.commandLineRun = commandLineRun;
